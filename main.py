...
def run(seed,
        ...
        project_name = env_name+("Non parallel")
        run_name =  kernel_name+"(nobreak)_lr="+str(lr) +"_"+str(1 *manipulate_state)+ str(1 *norm_grad) + str(1 *conf_grad) + str(1 *advantage_mean)+str(1 *adaptive_lr) +"_"+ str(seed)
