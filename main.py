...
def run(seed,
        ...
        project_name = env_name+("Mean + RBFSTATE + Tanh")
        run_name =  kernel_name+"_multir_lr="+str(lr) +"_"+str(1 *manipulate_state)+ str(1 *norm_grad) + str(1 *conf_grad) + str(1 *advantage_mean)+str(1 *adaptive_lr) +"_"+ str(seed)
...
if __name__ == '__main__':
        ...
        adaptive_lr = [False]
        learning_rate = 0.5 if kernel_name == ["rbfstate"] else 0.5
        lr = [learning_rate]
